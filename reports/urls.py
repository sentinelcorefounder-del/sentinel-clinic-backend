...
from .views import (
    ...
    EyeHealthScreeningOpsApproveView,
    EyeHealthScreeningOpsReturnView,
...
urlpatterns = [
    ...
    path("eye-health/<int:pk>/ops-approve/", EyeHealthScreeningOpsApproveView.as_view(), name="eye-health-ops-approve"),
    path("eye-health/<int:pk>/ops-return/", EyeHealthScreeningOpsReturnView.as_view(), name="eye-health-ops-return"),
